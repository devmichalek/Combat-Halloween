...
{
	if( !shuriken.load( "intro/shuriken.png" ) )
		return false;
	
	bg.setAlpha( 255 );
	if( !bg.create( screen_w, screen_h, 0x15, 0x15, 0x1D ) )
		return false;
	...
	// WHEN NOTHING...
	if( !text[ 0 ].setFont( "intro/Jaapokki-Regular.otf", 37, 0xFF, 0xFF, 0xFF ) )
		return false;
	else if( text[ 0 ].setText( "When nothing makes sense..." ) )
	{
	...
	// NINJA
	if( !text[ 1 ].setFont( "intro/Jaapokki-Regular.otf", 37, 0x70, 0xB7, 0x59 ) )
		return false;
	else if( text[ 1 ].setText( "Ninja" ) )
	{
	...
	// ADRIAN MICHALEK
	if( !text[ 2 ].setFont( "intro/Jaapokki-Regular.otf", 37, 0xFF, 0xFF, 0xFF ) )
		return false;
	else if( text[ 2 ].setText( "Adrian Michalek" ) )
	{
	...
	// PRODUCED ...
	if( !text[ 3 ].setFont( "intro/Jaapokki-Regular.otf", 37, 0x70, 0xB7, 0x59 ) )
		return false;
	else if( text[ 3 ].setText( "produced by" ) )
	{
