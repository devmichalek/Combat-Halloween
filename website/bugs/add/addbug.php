...
?>
	...
	<div class="container center">
		...
		<!-- Header -->
		<div class="s12"><h2 class="japokki-black A22">Combat Halloween Add Bug</h2></div>
		
		<!-- FORM -->
		<form class="col s12 m6 push-m3 japokki-black" method="post" action="add.php" style="margin-bottom: 20px;">

			<!-- NAME -->
			<div class="row">
			<div class="input-field col s12 m6 push-m3">
	          	<input id="name" type="text" class="validate" name="name" value="None" >
	            <label for="name"><h5 class="A1">Name</h5></label>
	        </div>
	    	</div>
			...
			<div class="row"><div class="input-field col s12 m6 push-m3">
	        	...
	        	<label for="location"><h5 class="A1">Location</h5></label>
	        </div></div>
			...
			<div class="row"><div class="input-field col s12 m6 push-m3">
	          ...
	          <label for="deadline"><h5 class="A1">Deadline</h5></label>
	        </div></div>
			...
			<div class="row"><div class="disabled input-field col s12 m6 push-m3">
	        	...
	        	<label for="author"><h5 class="A1">Author</h5></label>
	        </div></div>
			...
			<button class="btn waves-effect waves-light green lighten-1 japokki-white" type="submit" name="action">Add
